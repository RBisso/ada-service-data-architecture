...
Write-Host "=== Phase 3: Reverse Proxy Test ===" -ForegroundColor Cyan

# --- Start all services ---
Write-Host "`n[1/3] Starting all services via Docker Compose..." -ForegroundColor Yellow
...
try {
    Write-Host "`n[2/3] Testing endpoints through proxy (port 80)..." -ForegroundColor Yellow

Write-Host "=== Phase 4: Docker Compose Orchestration Manual Test ===" -ForegroundColor Cyan
...
# --- Start all services ---
Write-Host "[1/3] Starting all services via Docker Compose..." -ForegroundColor Yellow
...
# --- Seed some data ---
Write-Host "[2/3] Seeding sample products..." -ForegroundColor Yellow
...
# --- Status ---
Write-Host "[3/3] Orchestration status..." -ForegroundColor Yellow
docker compose ps
